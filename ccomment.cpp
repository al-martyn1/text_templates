...
namespace TextTP
{
   void commentText(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos);
   void uncommentText(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos);
   void SelectCommentedText(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos);

   void indentText(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos);
   void unindentText(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos);
   void indentText1(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos);
   void unindentText1(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos);

   void selectLinesBlockUp(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos);
   void selectLinesBlockDown(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos);
   void selectCodeBlock(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos);
   void selectCodeBlockAndHeader(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos);

   void moveToSelStart(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos);
   void moveToSelEnd(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos);
   void clearSelection(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos);


   void indentTextAux(int useTabs, int tabSize, int startLine, int startPos, int endLine, int endPos);
   void unindentTextAux(int useTabs, int tabSize, int startLine, int startPos, int endLine, int endPos);
...
#define INIT_MENU_STRING(var, rcId, str)        \
   ...
   doCommentingJob()
   {
      struct FarMenuItem        menuItems[17]   =
      {
         0
      };
      ...
      menuItems[13].Separator = 1;
      INIT_MENU_STRING(menuItems[14].Text, IDM_MOVE_TO_SELECTION_START, "&M Move to selection start");
      INIT_MENU_STRING(menuItems[15].Text, IDM_MOVE_TO_SELECTION_END, "&E Move to selection end");
      INIT_MENU_STRING(menuItems[16].Text, IDM_CLEAR_SELECTION, "&T Clear selection");
      //INIT_MENU_STRING(menuItems[].Text, , );

      char      title[128];
      INIT_MENU_STRING(title, IDM_COMMENTING_CODE, "Commenting code");

      int       menuRes = ::Info.Menu(-1, -1, 0, FMENU_WRAPMODE, title, 0, 0, /* Help topic */
                                 0, 0, menuItems, sizeof(menuItems) / sizeof(menuItems[0]));
   ...
   //-----------------------------------------------------------------------------
   int
   findFirstNonSpace(const EditorInfo& edinfo, const char* str, int strLen)
   {
      //int res = 0;
   ...
   //-----------------------------------------------------------------------------
   int
   findLeftmostNonSpace(const EditorInfo& edinfo, int startLine, int endLine)
   {
      ...
      for (; startLine != endLine; ++startLine)
      {
         ...
         {
            return 0;
         } //failed to get info about string
   ...
   //-----------------------------------------------------------------------------
   int
   findLastNonSpace(const EditorInfo& edinfo, const char* str, int strLen)
   {
   ...
   //-----------------------------------------------------------------------------
   int
   findMaxStringLen(const EditorInfo& edinfo, int startLine, int endLine)
   {
   ...
   //-----------------------------------------------------------------------------
   void
   indentTextAux(int useTabs, int tabSize, int startLine, int startPos, int endLine, int endPos)
   {
      for (; startLine != endLine; ++startLine)
      {
         EditorGetString        egs     =
         ...
         EditorSetString        ess     =
         {
            startLine, buf, (char*) egs.StringEOL, newSize
         };
   ...
   //-----------------------------------------------------------------------------
   void
   indentText(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
      indentTextAux((edinfo.Options & EOPT_EXPANDTABS) ? 0 : 1, edinfo.TabSize, startLine, startPos, endLine, endPos);
   }

   //-----------------------------------------------------------------------------
   void
   indentText1(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
   ...
   //-----------------------------------------------------------------------------
   void
   unindentTextAux(int useTabs, int tabSize, int startLine, int startPos, int endLine, int endPos)
   {
      for (; startLine != endLine; ++startLine)
      {
         EditorGetString        egs     =
         ...
         EditorSetString        ess     =
         {
            startLine, (char*) pTxt, (char*) egs.StringEOL, egs.StringLength - i
         };
         ::Info.EditorCtrlSetString(&ess);
      }
   }
   ...
   //-----------------------------------------------------------------------------
   void
   unindentText(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
      unindentTextAux((edinfo.Options & EOPT_EXPANDTABS) ? 0 : 1, edinfo.TabSize, startLine, startPos, endLine, endPos);
   }

   //-----------------------------------------------------------------------------
   void
   unindentText1(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
   ...
   inline
   bool
   isSpaceOnlyString(int lineNo, bool spaceOnly)
   {
      std::string       line;
   ...
   int
   findSpaceOnlyString(int startLine, int endLine, int direction, bool spaceOnly)
   {
      if (!direction)
      {
         direction = 1;
      ...
      {
         if (isSpaceOnlyString(startLine, spaceOnly))
         {
            break;
         }
      }
   ...
   //-----------------------------------------------------------------------------
   void
   selectLinesBlockUp(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
      ...
      if (!selected)
      {
         if (isSpaceOnlyString(edinfo.CurLine, true /*spaceOnly*/))
         {
            ...
            selEndLine = findSpaceOnlyString(edinfo.CurLine, -1 /* up range */, -1 /* dir - up*/, false /*!spaceOnly*/);
            if (selEndLine < 0)
            {
               return;
            } // block begin not found at all

            if ((edinfo.CurLine - selEndLine) > 3)
            {
               return;
            } // found block is too far from cur line
         ...
         else
         {
            ...
            selEndLine = findSpaceOnlyString(edinfo.CurLine, edinfo.TotalLines /* down range */, 1 /* dir - down*/, true /*spaceOnly*/);
            if (selEndLine < 0)
            {
         ...
         selStartLine = findSpaceOnlyString(selEndLine - 1, -1 /* up range */, -1 /* dir - up*/, true /*spaceOnly*/);
         if (selStartLine < 0)
         {
            selStartLine = 0;
         }
         ...
         ::Info.EditorCtrlSelect(BTYPE_STREAM, selStartLine, 0, 0, selEndLine - selStartLine + 1);
         return;
      }

      selStartLine = findSpaceOnlyString(startLine - 1, -1 /* up range */, -1 /* dir - down*/, false /*!spaceOnly*/);
      if (selStartLine < 0)
      {
         return;
      } // no next block found, BOF reached

      selStartLine = findSpaceOnlyString(selStartLine - 1, -1 /* up range */, -1 /* dir - down*/, true /*spaceOnly*/);
      if (selStartLine < 0)
      {
         selStartLine = 0;
      }
   ...
   //-----------------------------------------------------------------------------
   void
   selectLinesBlockDown(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
      int       selStartLine    = startLine;
      int       selEndLine      = endLine;
      if (!selected)
      {
         if (isSpaceOnlyString(edinfo.CurLine, true /*spaceOnly*/))
         {
            ...
            // но не далее трех строк от текущей
            selStartLine = findSpaceOnlyString(edinfo.CurLine + 1, edinfo.TotalLines /* down range */, 1 /* dir - down*/, false /*!spaceOnly*/);
            if (selStartLine < 0)
            {
               return;
            } // block begin not found at all
         ...
         else
         {
            ...
            selStartLine = findSpaceOnlyString(edinfo.CurLine - 1, -1 /* up range */, -1 /* dir - up*/, true /*spaceOnly*/);
            if (selStartLine < 0)
            {
               selStartLine = 0;
            }
         ...
         selEndLine = findSpaceOnlyString(selStartLine, edinfo.TotalLines /* down range */, 1 /* dir - down*/, true /*spaceOnly*/);
         if (selEndLine < 0)
         {
            selEndLine = edinfo.TotalLines;
         }
      ...
      selEndLine = findSpaceOnlyString(endLine + 1, edinfo.TotalLines /* down range */, 1 /* dir - down*/, false /*!spaceOnly*/);
      if (selEndLine < 0)
      {
         return;
      } // no next block found, EOF reached

      selEndLine = findSpaceOnlyString(selEndLine + 1, edinfo.TotalLines /* down range */, 1 /* dir - down*/, true /*spaceOnly*/);
      if (selEndLine < 0)
      {
         selEndLine = edinfo.TotalLines;
      }
   ...
   //-----------------------------------------------------------------------------
   void
   selectLinesBlock(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
      std::string       line;
      ...
      int       selStartLine    = findSpaceOnlyString(edinfo.CurLine, -1 /* up range */, -1 /* dir - up*/, true /*spaceOnly*/);
      ...
      int       selEndLine      = findSpaceOnlyString(edinfo.CurLine, edinfo.TotalLines /* down range */, 1 /* dir - down*/, true /*spaceOnly*/);
      if (selEndLine < 0)
      {
         selEndLine = edinfo.TotalLines;
      }
   ...
   */
   ...
   int
   selBlockTestString(const SelectionBlockInfo& sbi, const std::string& line, bool caseSens)
   {
      ...
      if (Utils::strStartsWith(str, beginStr))
      {
         return 1;
      }
      if (Utils::strStartsWith(str, endStr))
      {
         return -1;
      }
      return 0;
   ...
   struct FoundBlockBeginInfo
   {
      ...
      FoundBlockBeginInfo&
      operator=(const FoundBlockBeginInfo& fbbi)
      {
         if (&fbbi == this)
         {
            return *this;
      ...
      bool
      operator<(const FoundBlockBeginInfo& fbbi) const
      {
   ...
   bool
   findBlockBegin(FoundBlockBeginInfo& fbbi, bool caseSens)
   {
      int       cnt     = 0;
   ...
   int
   findBlockEnd(const FoundBlockBeginInfo& fbbi, bool caseSens, int fromLine, int totalLines)
   {
      int       cnt     = 0;
   ...
   //-----------------------------------------------------------------------------
   bool selectCodeBlockAux(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos, int& retSelStart, int& retSelEnd, SelectionInfo& selInfo);
   bool
   selectCodeBlockAux(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos, int& retSelStart, int& retSelEnd, SelectionInfo& selInfo)
   {
      if (!edinfo.FileName)
      {
         return false;
      ...
      {
         selectLinesBlock(edinfo, selected, startLine, startPos, endLine, endPos);
         return false;
      } 
      ...
      for (; bIt != selInfo.selBlockInfoVec.end(); ++bIt)
      {
         ...
         if (!findBlockBegin(fbbi, selInfo.case_sensitive))
         {
            continue;
         }
   ...
   //-----------------------------------------------------------------------------
   void
   selectCodeBlock(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
      int               retSelStart     = -1, retSelEnd = -1;
      SelectionInfo     selInfo;
      if (!selectCodeBlockAux(edinfo, selected, startLine, startPos, endLine, endPos, retSelStart, retSelEnd, selInfo))
      {
         return;
      }
      ...
      ::Info.EditorCtrlSelect(BTYPE_STREAM, retSelStart, 0, 0, retSelEnd - retSelStart + 1);
   }

   //-----------------------------------------------------------------------------
   bool selBlockAndHeaderTestString(const std::vector<SelectionBlockInfo>& vec, const std::string& line, bool caseSens);
   bool
   selBlockAndHeaderTestString(const std::vector<SelectionBlockInfo>& vec, const std::string& line, bool caseSens)
   {
      if (Utils::isSpaceOnlyString(line))
      {
   ...
   //-----------------------------------------------------------------------------
   void
   selectCodeBlockAndHeader(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
      int               retSelStart     = -1, retSelEnd = -1;
      SelectionInfo     selInfo;
      if (!selectCodeBlockAux(edinfo, selected, startLine, startPos, endLine, endPos, retSelStart, retSelEnd, selInfo))
   ...
   //-----------------------------------------------------------------------------
   CommentTypeEnum findCommentInfoByType(const std::vector<CommentInfo>& ciVec, CommentInfo& foundCi, CommentTypeEnum requestedCommentType);
   CommentTypeEnum
   findCommentInfoByType(const std::vector<CommentInfo>& ciVec, CommentInfo& foundCi, CommentTypeEnum requestedCommentType)
   {
      //SS;
   ...
   inline
   std::string
   appendWhiteSpaces(const std::string& s, int lenNeeded)
   {
      ...
      return s + std::string((std::string::size_type) lenNeeded - s.size(), ' ');
   }

   //-----------------------------------------------------------------------------
   void
   commentText(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
      if (!edinfo.FileName)
      {
         return;
      ...
      {
         std::string            commentBegin    = makeSpaceString(ci.new_line_indent_before) + beginSequence + makeSpaceString(ci.indent);

         std::string            commentEnd      = makeSpaceString(ci.indent) + endSequence + makeSpaceString(ci.new_line_indent_before);
         ...
         if (edinfo.BlockType == BTYPE_COLUMN)
         {
            ...
            if (selected)
            {
               ::Info.EditorCtrlSelect(BTYPE_COLUMN, startLine, startPos, endPos - startPos, endLine - startLine);
            }
         }
         else // if (edinfo.BlockType==BTYPE_COLUMN)
         {
            ...
            if (selected)
            {
               ::Info.EditorCtrlSelect(BTYPE_STREAM, startLine, startPos, endPos - startPos, endLine - startLine);
            }
         } // else if (edinfo.BlockType==BTYPE_COLUMN)
      } // if (commentType==ctStream)
      else
      {
         ...
         beginSequence + makeSpaceString(ci.indent);
         ...
         {
            ::Info.EditorCtrlInsertNewString(endLine - 1, makeSpaceString(startPos) + makeSpaceString(ci.new_line_indent_before) + endSequence);
            endLine++;
         }
         /*
                                  else
         ...
         if (selected)
         {
            ::Info.EditorCtrlSelect(BTYPE_STREAM, startLine, 0, 0, endLine - startLine + 1);
         }
   ...
   int
   findCommentStart(const std::string& str, const std::string& commentBeginStr, int fromPos)
   {
      if (str.size() < commentBeginStr.size())
      {
         return -1;
      }
   ...
   int
   findCommentEnd(const std::string& str, const std::string& commentEndStr, int fromPos)
   {
      if (str.size() < commentEndStr.size())
      {
         return -1;
      }
   ...
   //-----------------------------------------------------------------------------
   bool findCommentInLine(const std::string& str, const std::string& commentBeginStr, const std::string& commentEndStr, int fromPos, int& foundBegin, int& foundEnd);
   bool
   findCommentInLine(const std::string& str, const std::string& commentBeginStr, const std::string& commentEndStr, int fromPos, int& foundBegin, int& foundEnd)
   {
   ...
   bool
   findIndentAtStart(const std::string& str, int fromPos, int indentSize)
   {
   ...
   bool
   findIndentAtEnd(const std::string& str, int fromPos, int indentSize)
   {
   ...
   //-----------------------------------------------------------------------------
   bool findSelectColumnComment(const EditorInfo& edinfo, const std::vector<CommentInfo>& commentSequences, bool bEraseDontSelect);
   bool
   findSelectColumnComment(const EditorInfo& edinfo, const std::vector<CommentInfo>& commentSequences, bool bEraseDontSelect)
   {
      CommentTypeEnum   commentType             = ctStream;
      CommentInfo       ci;
      CommentTypeEnum   foundCommentType        = findCommentInfoByType(commentSequences, ci, commentType);
      ...
      {
         return false;
      } // Подходящий тип коментария не найден
      ...
      if (!findCommentInLine(line, beginSequence, endSequence, edinfo.CurPos, selStart, selEnd))
      {
         return false;
      ...
      for (--selStartLine; selStartLine >= 0; --selStartLine)
      {
         ...
         int            ss      = 0, se = 0;
         if (!findCommentInLine(line, beginSequence, endSequence, edinfo.CurPos, ss, se))
         {
            break;
         } // коментарий не найден
         ...
         {
            break;
         } // коментарий найден не в той же позиции
      ...
      if (bEraseDontSelect)
      {
         ...
         for (int lineNo = selStartLine; lineNo < selEndLine; ++lineNo)
         {
            ...
            line.erase((std::string::size_type) selEndIndentBeforePos, (std::string::size_type) (selEnd - selEndIndentBeforePos));
            line.erase((std::string::size_type) selStart, (std::string::size_type) (selStartIndentAfterPos - selStart));
            ::Info.EditorCtrlSetString(lineNo, line, eol);
         }

         selEnd -= (selStartIndentAfterPos - selStart) + (selEnd - selEndIndentBeforePos);
         ::Info.EditorCtrlSelect(BTYPE_COLUMN, selStartLine, selStart, selEnd - selStart, selEndLine - selStartLine);
   ...
   //    1 if begin found
   //    2 if end found
   int testLineStartsWithComment(const std::string& str, const std::string& beginSequence, const std::string& endSequence, const std::string& sequence, int& foundPos);
   int
   testLineStartsWithComment(const std::string& str, const std::string& beginSequence, const std::string& endSequence, const std::string& sequence, int& foundPos)
   {
      int       size    = (int) str.size();
      ...
      {
         if (!sequence.empty() && Utils::strStartsWith(tmp, sequence))
         {
            return 0;
         }
      }

      if (!beginSequence.empty() && Utils::strStartsWith(tmp, beginSequence))
      {
         return 1;
      }
      if (!endSequence.empty() && Utils::strStartsWith(tmp, endSequence))
      {
         return 2;
      }
   ...
   //-----------------------------------------------------------------------------
   bool findSelectLinesBlockComment(const EditorInfo& edinfo, const std::vector<CommentInfo>& commentSequences, bool bEraseDontSelect);
   bool
   findSelectLinesBlockComment(const EditorInfo& edinfo, const std::vector<CommentInfo>& commentSequences, bool bEraseDontSelect)
   {
      ...
      for (; firstLine >= 0; --firstLine)
      {
         ...
         testRes = testLineStartsWithComment(line, beginSequence, endSequence, sequence, firstLineFoundPos);
      ...
      for (; endLine < edinfo.TotalLines; ++endLine)
      {
         ...
         testRes = testLineStartsWithComment(line, beginSequence, endSequence, sequence, lastLineFoundPos);
      ...
      if (!bEraseDontSelect)
      {
         ::Info.EditorCtrlSelect(BTYPE_STREAM, firstLine, 0, 0, endLine - firstLine + 1);
         return true;
      }
      ...
      for (int lineNo = firstLine; lineNo < endLine; ++lineNo)
      {
         ...
         int            atPos   = 0;
         testRes = testLineStartsWithComment(line, beginSequence, endSequence, sequence, atPos);
         if (testRes < 0)
         {
            continue;
         }
         ...
         {
            case 0:
               rmLen = (int) sequence.size(); break;

            case 1:
               rmLen = (int) beginSequence.size(); break;

            case 2:
               rmLen = (int) endSequence.size(); break;
         };
   ...
   //-----------------------------------------------------------------------------
   bool findSelectStreamComment(const EditorInfo& edinfo, const std::vector<CommentInfo>& commentSequences, bool bEraseDontSelect);
   bool
   findSelectStreamComment(const EditorInfo& edinfo, const std::vector<CommentInfo>& commentSequences, bool bEraseDontSelect)
   {
      CommentTypeEnum   commentType             = ctStream;
      CommentInfo       ci;
      CommentTypeEnum   foundCommentType        = findCommentInfoByType(commentSequences, ci, commentType);
   ...
   //-----------------------------------------------------------------------------
   void SelectOrRemoveComment(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos, bool bEraseDontSelect);
   void
   SelectOrRemoveComment(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos, bool bEraseDontSelect)
   {
      if (!edinfo.FileName)
      {
         return;
   ...
   //-----------------------------------------------------------------------------
   void
   SelectCommentedText(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
      SelectOrRemoveComment(edinfo, selected, startLine, startPos, endLine, endPos, false /* bEraseDontSelect */);
   }

   //-----------------------------------------------------------------------------
   void
   uncommentText(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
      if (!selected)
      {
         return;
      }
      SelectOrRemoveComment(edinfo, selected, startLine, startPos, endLine, endPos, true /* bEraseDontSelect */);
   }

   //-----------------------------------------------------------------------------
   void
   moveToSelStart(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
      if (!selected)
      {
         return;
   ...
   void
   moveToSelEnd(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
      if (!selected)
      {
         return;
   ...
   void
   clearSelection(const EditorInfo& edinfo, bool selected, int startLine, int startPos, int endLine, int endPos)
   {
