...
struct Primitive<bool>
{
    ...
    { 
        if (EqualCI(s, _T("true")))
           ...
           {
            std::string msg = s; //tstring(_T("Can't parse to bool: ")) + s;
            throw ParseValueException(tstring(_T("Can't parse to bool: ")) + msg);
            }   
    }
};
//----------------------------------------------------------)
...
struct Primitive<char>
{
    ...
    { 
        ...
        if (n < SCHAR_MIN || n > SCHAR_MAX)
            {
                std::string msg = s; 
                throw ParseValueException(tstring(_T("Can't parse to char: ")) + msg);  
            }
...
struct Primitive<byte>
{
    ...
    { 
        ...
        if (n > UCHAR_MAX)
            {
                std::string msg = s; 
            throw ParseValueException(tstring(_T("Can't parse to byte: ")) + msg);
            }
...
struct Primitive<int>
{
    ...
    { 
        ...
        if (n < INT_MIN || n > INT_MAX)
            {
                std::string msg = s; 
            throw ParseValueException(tstring(_T("Can't parse to int: ")) + msg);
            }
...
struct Primitive<uint>
{
    ...
    { 
        ...
        if (n > UINT_MAX)
            {
                std::string msg = s; 
            throw ParseValueException(tstring(_T("Can't parse to uint: ")) + msg);
        }   
...
struct Primitive<short>
{
    ...
    { 
        ...
        if (n < SHRT_MIN || n > SHRT_MAX)
            {
                std::string msg = s; 
            throw ParseValueException(tstring(_T("Can't parse to short: ")) + msg);
            }
...
struct Primitive<ushort>
{
    ...
    { 
        ...
        if (n > USHRT_MAX)
            {
                std::string msg = s; 
            throw ParseValueException(tstring(_T("Can't parse to ushort: ")) + msg);
            }
...
struct Primitive<long>
{
    ...
    { 
        ...
        if (n < LONG_MIN || n > LONG_MAX)
            {
                std::string msg = s; 
            throw ParseValueException(tstring(_T("Can't parse to long: ")) + msg);
            }
...
struct Primitive<ulong>
{
    ...
    { 
        ...
        if (n > ULONG_MAX)
            {
                std::string msg = s; 
            throw ParseValueException(tstring(_T("Can't parse to ulong: ")) + msg);
            }
...
struct Primitive<float>
{
    ...
    { 
        ...
        if (d > FLT_MAX)
            {
                std::string msg = s; 
            throw ParseValueException(tstring(_T("Can't parse to float: ")) + msg);
            }
...
public:
    ...
    EnumType Parse(const tstring& name) const
    {
        ...
        if (it == values.end())
            throw ParseValueException(name + tstring(_T(" is not member of enum")));
        return it->second;
    }
protected:
...
{ \
 ...
 \
template <> \
static const MetaClass<EnumType>& Serializer::DefaultMetaClass<EnumType>() \
