...
{ AFS 15 Jan 2k
  ...
  This {} project uses very little in the way of internal function libs
  This {} project uses very little in the way of internal function libs
  as m { } ost is covered by JCL
  as m { } ost is covered by JCL
  I wa { } s using ComponentFunctions from my Jedi VCL kit
  howe {  } ver that is causing linkage problems with the IDE plugin - it is a package
  and  {  } 2 packages can't package the same stuff,
  and  {  } 2 packages can't package the same stuff,
  also {   }  it creates version dependencies - it bombed with the different version
  also {   }  it creates version dependencies - it bombed with the different version
  of C {   } omponentFunctions that I have at work
  of C {     } omponentFunctions that I have at work
       {     } 
...
begin
if CharIsAlpha(str[liLoop]) then begin
Result := True;
break;
end;
end;
